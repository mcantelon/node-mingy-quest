    ...
    fs.readdir(dir, function(err, files) {
      ...
      files.forEach(function(file) {
        var commandData = yaml.safeLoad(fs.readFileSync(path.join(dir, file), 'utf8'))
          , logic = eval('(function(game) { var player = game.player; var locations = game.locations; var doors = game.doors; var state = game.state; return function(arg, env) { ' + commandData.logic + '}; })(self)');
